...
def insert_command():
    backend.backendInsert(title_text.get(),author_text.get(),year_text.get(),price_text.get())
    list1.delete(0,END)
...
def update_command():
    backend.update(title_text.get(),author_text.get(),year_text.get(),price_text.get(),selected_tuple[0])
